...
/// animate and drag (which is what made the home↔detail switch jump).
///
/// Activating (no `.nonactivatingPanel`) so the search field gets a real, stable
/// insertion point — non-activating panels give text fields a flaky cursor.
final class GlassPanel: NSPanel {
    ...
    init<Content: View>(content: Content) {
        ...
        super.init(contentRect: NSRect(x: 0, y: 0, width: 264, height: 600),
        ...
        host.frame = NSRect(x: 0, y: 0, width: 264, height: 600)
